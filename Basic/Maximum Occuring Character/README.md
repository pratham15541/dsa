<h2><a href="https://practice.geeksforgeeks.org/problems/maximum-occuring-character-1587115620/1?utm_source=gfg&utm_medium=article&utm_campaign=bottom_sticky_on_article">Maximum Occuring Character</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a string&nbsp;<strong>str </strong>of lowercase alphabets. The task is to find the maximum occurring character in the string <strong>str</strong>. If more than one character occurs the maximum number of time then print the lexicographically smaller character.</span></p>
